...
static PyObject * 
pypmc_sync( PyPMC *self, PyObject *args )
{
...
static PyMethodDef pypmc_methods[] = {
    ...
    {"sync", (PyCFunction) pypmc_sync, METH_NOARGS,
     "Makes sure the previous simulation has finished running."},
